...
# Memory: data_buffer
MEM_0 := nios_core_data_buffer
$(MEM_0)_NAME := data_buffer
...
$(MEM_0)_START := 0x11080000
$(MEM_0)_END := 0x11080fff
$(MEM_0)_SPAN := 0x00001000
$(MEM_0)_HIERARCHICAL_PATH := data_buffer
$(MEM_0)_WIDTH := 32
...
.PHONY: data_buffer
data_buffer: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_SPAN := 0x10000000
$(MEM_1)_HIERARCHICAL_PATH := ddr3
$(MEM_1)_WIDTH := 128
...
$(MEM_2)_START := 0x11040000
$(MEM_2)_END := 0x1107ffff
