...
module nios_core_mm_interconnect_1 (
	...
	wire         cmd_mux_src_valid;                                                           // cmd_mux:src_valid -> pio_key_s1_agent:cp_valid
	wire  [82:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> pio_key_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                           // pio_key_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> pio_key_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                   // cmd_mux:src_startofpacket -> pio_key_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                     // cmd_mux:src_endofpacket -> pio_key_s1_agent:cp_endofpacket
	...
	wire  [82:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> pio_led_s1_agent:cp_data
	...
	wire  [82:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> pio_sw_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // pio_sw_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> pio_sw_s1_agent:cp_channel
	...
	wire   [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> i2c_scl_s1_agent:cp_channel
	...
	wire   [4:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> i2c_sda_s1_agent:cp_channel
	...
	wire         pio_key_s1_agent_rp_valid;                                                   // pio_key_s1_agent:rp_valid -> router_001:sink_valid
	wire  [82:0] pio_key_s1_agent_rp_data;                                                    // pio_key_s1_agent:rp_data -> router_001:sink_data
	wire         pio_key_s1_agent_rp_ready;                                                   // router_001:sink_ready -> pio_key_s1_agent:rp_ready
	wire         pio_key_s1_agent_rp_startofpacket;                                           // pio_key_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         pio_key_s1_agent_rp_endofpacket;                                             // pio_key_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [82:0] pio_led_s1_agent_rp_data;                                                    // pio_led_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [82:0] pio_sw_s1_agent_rp_data;                                                     // pio_sw_s1_agent:rp_data -> router_003:sink_data
	...
	wire   [4:0] router_src_channel;                                                          // router:src_channel -> cpu_peripheral_bridge_m0_limiter:cmd_sink_channel
	...
	wire   [4:0] cpu_peripheral_bridge_m0_limiter_cmd_src_channel;                            // cpu_peripheral_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [4:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> cpu_peripheral_bridge_m0_limiter:rsp_sink_channel
	...
	wire   [4:0] cpu_peripheral_bridge_m0_limiter_rsp_src_channel;                            // cpu_peripheral_bridge_m0_limiter:rsp_src_channel -> cpu_peripheral_bridge_m0_agent:rp_channel
	...
	wire   [4:0] cpu_peripheral_bridge_m0_limiter_cmd_valid_data;                             // cpu_peripheral_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire         pio_key_s1_agent_rdata_fifo_src_valid;                                       // pio_key_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] pio_key_s1_agent_rdata_fifo_src_data;                                        // pio_key_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         pio_key_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter:in_0_ready -> pio_key_s1_agent:rdata_fifo_src_ready
	...
	nios_core_mm_interconnect_1_router router (
	...
	nios_core_mm_interconnect_1_router_001 router_001 (
	...
	nios_core_mm_interconnect_1_router_001 router_002 (
	...
	nios_core_mm_interconnect_1_router_001 router_003 (
	...
	nios_core_mm_interconnect_1_router_001 router_004 (
	...
	nios_core_mm_interconnect_1_router_001 router_005 (
	...
	nios_core_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_sys_outclk1_clk),                                        //        clk.clk
		.reset              (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	nios_core_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset               (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset               (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset               (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset               (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset               (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset              (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset              (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset              (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset              (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset              (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_sys_outclk1_clk),                                        //       clk.clk
		.reset               (cpu_peripheral_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_sys_outclk1_clk),                                        // in_clk_0.clk
