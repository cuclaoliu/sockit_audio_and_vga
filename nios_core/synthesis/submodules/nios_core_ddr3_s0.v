...
module nios_core_ddr3_s0 (
	...
	rw_manager_ddr3 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("CYCLONEV"),
		.AC_ROM_INIT_FILE_NAME                ("nios_core_ddr3_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("nios_core_ddr3_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (14336),
		.INIT_FILE        ("nios_core_ddr3_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	nios_core_ddr3_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	nios_core_ddr3_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
